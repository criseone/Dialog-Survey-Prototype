...
function () {
  ...
  Provider.prototype.initialize = function (opts) {
    ...
    try {
      ...
      for (var _d = (0, _tslib.__values)(this.instancesDeferred.entries()), _e = _d.next(); !_e.done; _e = _d.next()) {
        var _f = (0, _tslib.__read)(_e.value, 2),
...
},{"@firebase/app":"node_modules/@firebase/app/dist/index.esm.js"}],"../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
exports.ServerValue = exports.Reference = exports.Query = exports.OnDisconnect = exports.Database = exports.DataSnapshot = void 0;
...
var logWrapper = function (prefix) {
  return function () {
    ...
    log.apply(void 0, (0, _tslib.__spreadArray)([prefix], (0, _tslib.__read)(varArgs)));
  };
};
...
var error = function () {
  ...
  var message = 'FIREBASE INTERNAL ERROR: ' + buildLogMessage_.apply(void 0, (0, _tslib.__spreadArray)([], (0, _tslib.__read)(varArgs)));
...
var fatal = function () {
  ...
  var message = "FIREBASE FATAL ERROR: " + buildLogMessage_.apply(void 0, (0, _tslib.__spreadArray)([], (0, _tslib.__read)(varArgs)));
  logClient.error(message);
...
var warn = function () {
  ...
  var message = 'FIREBASE WARNING: ' + buildLogMessage_.apply(void 0, (0, _tslib.__spreadArray)([], (0, _tslib.__read)(varArgs)));
...
function () {
  ...
  EventEmitter.prototype.trigger = function (eventType) {
    ...
    if (Array.isArray(this.listeners_[eventType])) {
      ...
      var listeners = (0, _tslib.__spreadArray)([], (0, _tslib.__read)(this.listeners_[eventType]));
      ...
      if (write.snap) {
        ...
        if (pathContains(treeRoot, writePath)) {
          ...
          if (pathIsEmpty(relativePath)) {
            ...
            var child = (0, _util.safeGet)(write.children, pathGetFront(relativePath));
...
function syncPointApplyOperation(syncPoint, operation, writesCache, optCompleteServerCache) {
  ...
  if (queryId !== null) {
    ...
    try {
      for (var _b = (0, _tslib.__values)(syncPoint.views.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
        var view = _c.value;
...
function syncPointRemoveEventRegistration(syncPoint, query, eventRegistration, cancelError) {
  ...
  if (queryId === 'default') {
    try {
      ...
      for (var _b = (0, _tslib.__values)(syncPoint.views.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
        var _d = (0, _tslib.__read)(_c.value, 2),
            viewQueryId = _d[0],
            view = _d[1];
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(ReferenceImpl, _super);
  /** @hideconstructor */
...
function () {
  ...
  ChildEventRegistration.prototype.respondsTo = function (eventType) {
    ...
    return (0, _util.contains)(this.callbacks, eventToCheck);
  };
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(QueryEndAtConstraint, _super);
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(QueryEndBeforeConstraint, _super);
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(QueryStartAtConstraint, _super);
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(QueryStartAfterConstraint, _super);
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(QueryLimitToFirstConstraint, _super);
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(QueryLimitToLastConstraint, _super);
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(QueryOrderByChildConstraint, _super);
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(QueryOrderByKeyConstraint, _super);
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(QueryOrderByPriorityConstraint, _super);
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(QueryOrderByValueConstraint, _super);
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(QueryEqualToValueConstraint, _super);
...
function query(query) {
  ...
  try {
    for (var queryConstraints_1 = (0, _tslib.__values)(queryConstraints), queryConstraints_1_1 = queryConstraints_1.next(); !queryConstraints_1_1.done; queryConstraints_1_1 = queryConstraints_1.next()) {
...
},{"@firebase/app":"node_modules/@firebase/app/dist/index.esm.js","@firebase/component":"node_modules/@firebase/component/dist/index.esm.js","@firebase/util":"node_modules/@firebase/util/dist/index.esm.js","tslib":"node_modules/tslib/tslib.es6.js","@firebase/logger":"node_modules/@firebase/logger/dist/index.esm.js","process":"../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/firebase/database/dist/index.esm.js":[function(require,module,exports) {
"use strict";

require("@firebase/database");
},{"@firebase/database":"node_modules/@firebase/database/dist/index.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var el1 = document.getElementById("action"); // el.addEventListener("click", () => { modifyText("Lit!"); }, false);

el1.addEventListener("click", function () {
  return document.getElementById("start").style.display = "none";
});
el1.addEventListener("click", function () {
  return document.getElementById("q1").style.display = "flex";
});
el1.addEventListener("click", function () {
  return console.log("user onboard");
}); // Add event listener to button with an arrow function

var el2 = document.getElementById("yes1"); // el.addEventListener("click", () => { modifyText("Lit!"); }, false);

el2.addEventListener("click", function () {
  return document.getElementById("q1").style.display = "none";
});
el2.addEventListener("click", function () {
  return document.getElementById("q2").style.display = "flex";
...
//# sourceMappingURL=/Dialog-Survey-Prototype.e31bb0bc.js.map